...
@Component({
    selector: 'app-userrejectedapplications',
    templateUrl: './userrejectedapplications.component.html',
    styleUrls: ['./userrejectedapplications.component.css']
})
export class UserrejectedapplicationsComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.salesService.getUserRejectedApplications(this.userId).subscribe(applicants => {
